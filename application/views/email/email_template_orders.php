        ...
        <section>
            <div class="container">
                <div class="bg-white padding-30">
                    ...
                    <div class="back-blue">
                        <h1 class="text-center">Form Order</h1>
                        <div class="mb-10">
                            <p class="mb-0">Nama</p>
                        ...
                        <div class="mb-10">
                            ...
                            <div class="form-info"><?php echo $tanggal;?></div>
                        </div>
                        <div class="mb-10">
                            <p class="mb-0">Jenis</p>
                            <div class="form-info"><?php echo $jenis;?></div>
                        </div>
                        <div class="mb-10">
                            <p class="mb-0">QTY</p>
                            <div class="form-info"><?php echo $qty;?></div>
                        </div>
                        <div class="mb-10">
                            <p class="mb-0">Message</p>
                            <div class="form-info"><?php echo $pesan;?></div>
                        </div>
                        <br>
                        <div class="blues text-center">Copyright © 2020 Lookit! Studio & Photography, All Rights Reserved.</div>
                        <br>
                    </div>
                </div>
            </div>
