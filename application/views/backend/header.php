...
<head>
    ...
    <link href="<?php echo base_url("assets/backend/");?>vendors/vectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" type="text/css" />



    <!-- Data Table CSS -->

    <link href="<?php echo base_url("assets/backend/");?>vendors/datatables.net-dt/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />

    <link href="<?php echo base_url("assets/backend/");?>vendors/datatables.net-responsive-dt/css/responsive.dataTables.min.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo base_url("assets/backend/");?>vendors/jquery-toast-plugin/dist/jquery.toast.min.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo base_url("assets/backend/");?>vendors/dropzone/dist/dropzone.css" rel="stylesheet" type="text/css"/>

    

    <!-- Bootstrap Dropzone CSS -->

    <link href="<?php echo base_url("assets/backend/");?>vendors/dropify/dist/css/dropify.min.css" rel="stylesheet" type="text/css"/>
    ...
    <div class="hk-wrapper hk-vertical-nav">
        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
            ...
            <a class="navbar-brand" href="dashboard1.html">
                ...
                <img class="brand-img d-inline-block brandlogo" src="<?= base_url("assets/images/");?>perspektiv-logo-white.png" alt="brand" />
            ...
            <ul class="navbar-nav hk-navbar-content">
                ...
                <li class="nav-item dropdown dropdown-authentication">
                    ...
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <span>Halo, <?php echo $this->session->userdata('username');?><i class="zmdi zmdi-chevron-down"></i></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                        ...
                        <a class="dropdown-item" href="<?= site_url("backend/do_logout")?>"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
                ...
                <div class="navbar-nav-wrap">
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/portfolio");?>" >
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/service");?>" >
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/request_order");?>" >

                                <span class="feather-icon"><i data-feather="layout"></i></span>

                                <span class="nav-link-text">Request Order</span>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/contact");?>" >
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/news");?>" >
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/vacancy");?>" >

                                <span class="feather-icon"><i data-feather="file-text"></i></span>

                                <span class="nav-link-text">Job Vacancy</span>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/mushollas");?>" >

                                <span class="feather-icon"><i data-feather="moon"></i></span>

                                <span class="nav-link-text">Musholla</span>
                        ...
                        <li class="nav-item hide-mobile">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/do_logout");?>" >
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="javascript:void(0);" data-toggle="collapse" data-target="#dash_drp">
                                ...
                                <span class="nav-link-text">Game Member</span>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" href="<?php echo site_url("backend/game_mobile_legends");?>">Mobile Legends</a>

                                        </li>

                                        <li class="nav-item">

                                            <a class="nav-link" href="<?php echo site_url("backend/game_pubgm");?>">PUBGM</a>

                                        </li>

                                        <li class="nav-item">

                                            <a class="nav-link" href="<?php echo site_url("backend/game_codm");?>">CODM</a>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/tournament");?>" >

                                <span class="feather-icon"><i data-feather="zap"></i></span>

                                <span class="nav-link-text">Tournament</span>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="<?php echo site_url("backend/achievement");?>" >

                                <span class="feather-icon"><i data-feather="anchor"></i></span>

                                <span class="nav-link-text">Achievement</span>
